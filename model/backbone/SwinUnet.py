...
from utils.visualization import layer_view_single_channel
...
if __name__=='__main__':
    ...
    print('In Channels: {}, Out Channels: {}, Batch Size: {}, Image Size: {}'.format(in_channels, out_channels, batch_size, image_size))
    net = SwinUnet_v2(img_size=image_size, in_chans=in_channels, num_classes=out_channels)
    summary(net, input_size=(in_channels, image_size, image_size), batch_size=batch_size)

    # test_image_path = '/Users/wanghaolin/GitHub/My-General-Framework/utils/test_images/test_image_hand_xray.jpg'
    ...
    # net = SwinUnet_v2(img_size=image_size, in_chans=in_channels, num_classes=out_channels).to(device)
    # test_result = net(test_image)
    #
